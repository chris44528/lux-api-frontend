    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-4xl max-h-[80vh] flex flex-col">
        <div className="p-4 border-b flex justify-between items-center">
          <h2 className="text-xl font-semibold">Manage Site Alerts</h2>
          <div className="flex items-center">
            <label className="inline-flex items-center mr-4">
              ...
              />
              <span className="ml-2 text-sm">Show inactive alerts</span>
            </label>
            <button
              onClick={onClose}
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {alerts.map((alert) => (
                <div 
                  key={alert.id} 
                  className={`border rounded-lg p-4 ${!alert.is_active || alert.is_expired ? 'opacity-60' : ''}`}
                >
                  ...
                  {confirmDelete === alert.id && (
                    <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded">
                      <p className="text-red-700 mb-2">Are you sure you want to delete this alert?</p>
