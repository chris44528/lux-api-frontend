...
const AddAlertModal: React.FC<AddAlertModalProps> = ({
  ...
  const [expirationType, setExpirationType] = useState<'date' | 'never'>('never');
    ...
    try {
      ...
      if (expirationType === 'date' && expiryDate) {
        ...
        if (selectedDate.toDateString() === today.toDateString()) {
          ...
          // For future dates, set time to end of that day
          selectedDate.setHours(23, 59, 59, 999);
        }
        
        // Convert to ISO string for the API
        processedExpiryDate = selectedDate.toISOString();
      }
      ...
      const payload = {
        ...
        expires_at: processedExpiryDate,
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-full max-w-md">
        <div className="p-4 border-b dark:border-gray-700">
          <h2 className="text-xl font-semibold dark:text-white">Add Site Alert</h2>
        </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Alert will expire at 11:59 PM on the selected date
                  </p>
                </div>
              </div>
            )}
